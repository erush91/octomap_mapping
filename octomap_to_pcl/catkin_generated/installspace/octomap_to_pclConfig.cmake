...
if(octomap_to_pcl_CONFIG_INCLUDED)
  return()
endif()
set(octomap_to_pcl_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(octomap_to_pcl_SOURCE_PREFIX /home/ohrad/catkin_ws/src/octomap_mapping/octomap_to_pcl)
  set(octomap_to_pcl_DEVEL_PREFIX /home/ohrad/catkin_ws/devel)
  set(octomap_to_pcl_INSTALL_PREFIX "")
  set(octomap_to_pcl_PREFIX ${octomap_to_pcl_DEVEL_PREFIX})
else()
  set(octomap_to_pcl_SOURCE_PREFIX "")
  set(octomap_to_pcl_DEVEL_PREFIX "")
  set(octomap_to_pcl_INSTALL_PREFIX /home/ohrad/catkin_ws/install)
  set(octomap_to_pcl_PREFIX ${octomap_to_pcl_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'octomap_to_pcl' is deprecated")
...
set(octomap_to_pcl_FOUND_CATKIN_PROJECT TRUE)
...
if(NOT "include;/usr/include/pcl-1.8;/usr/local/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(octomap_to_pcl_INCLUDE_DIRS "")
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ohrad/catkin_ws/install/lib;/home/ohrad/catkin_ws/devel/lib;/home/ohrad/compass_ws/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(octomap_to_pcl_LIBRARY_DIRS ${lib_path})
      list(APPEND octomap_to_pcl_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'octomap_to_pcl'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND octomap_to_pcl_LIBRARIES ${lib})
    endif()
  endif()
...
set(octomap_to_pcl_EXPORTED_TARGETS "octomap_to_pcl_generate_messages_cpp;octomap_to_pcl_generate_messages_eus;octomap_to_pcl_generate_messages_lisp;octomap_to_pcl_generate_messages_nodejs;octomap_to_pcl_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${octomap_to_pcl_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 octomap_to_pcl_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${octomap_to_pcl_dep}_FOUND)
      find_package(${octomap_to_pcl_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${octomap_to_pcl_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(octomap_to_pcl_INCLUDE_DIRS ${${octomap_to_pcl_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(octomap_to_pcl_LIBRARIES ${octomap_to_pcl_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${octomap_to_pcl_dep}_LIBRARIES})
  _list_append_deduplicate(octomap_to_pcl_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(octomap_to_pcl_LIBRARIES ${octomap_to_pcl_LIBRARIES})

  _list_append_unique(octomap_to_pcl_LIBRARY_DIRS ${${octomap_to_pcl_dep}_LIBRARY_DIRS})
  list(APPEND octomap_to_pcl_EXPORTED_TARGETS ${${octomap_to_pcl_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "octomap_to_pcl-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${octomap_to_pcl_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
